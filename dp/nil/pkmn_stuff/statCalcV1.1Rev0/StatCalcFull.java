...
public class StatCalcFull {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Type a number. For this current version (version 1.1 revision 0), it does not matter.");
	...
	public static void StatCalc(boolean randomEVs, boolean randomIVs, boolean realMode) {
		// This is the place to run the headed StatCalc method.
		/*Indexes:
		 * 0 is HP
		 * 1 is Atk
		 * 2 is Def
		...
		scan.close();
		Stats = StatCalc_Headed(Base, IVList, EVList, Level, Nature);
	...
	public static ArrayList<Integer> StatCalc_Headed(ArrayList<Integer> Base, ArrayList<Integer> IVList, ArrayList<Integer> EVList, int level, String naturestr){
